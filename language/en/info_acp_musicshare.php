...
$lang = array_merge($lang, [
	...
	'MS_SEC_FEATURES'		=> '7. Optional features',
	...
	'MUSICSHARE_ATTACH_IMPORT_OPT'		=> 'Import audio attachments into the library',
	'MUSICSHARE_ATTACH_IMPORT_OPT_EXPLAIN'	=> 'Shows an "Add to library" link under every audio attachment in a post, visible only to the person who wrote the post and to those who moderate songs. Importing is never automatic: the author chooses title, artist and genres, and only then does the song enter the library. A copy of the attachment is saved, so the song keeps working even if the post is later edited or removed.',

	'MUSICSHARE_AUTO_IMPORT'		=> 'Automatic import from forums',
	'MUSICSHARE_AUTO_IMPORT_EXPLAIN'	=> 'When a user attaches an audio file to a post in one of the forums selected below, the song enters the library on its own, with title and artist read from the file tags. No action from the author is needed. If the import fails, the post is published anyway and the attachment stays downloadable as always.',
	'MUSICSHARE_AUTO_FORUMS'		=> 'Forums to import from',
	'MUSICSHARE_AUTO_FORUMS_EXPLAIN'	=> 'Select only the sections dedicated to music. Careful: the library is single and visible to anyone with access to the Music section, while forums have their own read permissions. Importing from a restricted section would make those songs audible to people who cannot read that forum. Sections not readable by guests are marked.',
	'MUSICSHARE_FORUM_PRIVATE'		=> 'not public',
	'MUSICSHARE_AUTO_PENDING'		=> 'Hold imported songs for approval',
	'MUSICSHARE_AUTO_PENDING_EXPLAIN'	=> 'Recommended. Automatically imported songs were not chosen one by one by anyone: they stay pending until a moderator reviews them, even if general upload approval is disabled. You will find them in the Moderator Control Panel.',

	'MUSICSHARE_TOPIC_ENABLED'		=> 'Open a topic for every uploaded song',
	'MUSICSHARE_TOPIC_ENABLED_EXPLAIN'	=> 'When a user uploads a song, a topic is opened in their name in the forum selected below, with the player already embedded. The discussion then happens where everything else is discussed, and comments are real board posts. The topic is only opened for songs that are immediately visible: if the song is awaiting approval, no topic is created.',
	'MUSICSHARE_TOPIC_FORUM'		=> 'Forum to open the topics in',
	'MUSICSHARE_TOPIC_FORUM_NONE'	=> '(none: feature inactive)',
	'MUSICSHARE_TOPIC_FORUM_EXPLAIN'	=> 'Choose a dedicated section. Users must be able to post there: if the forum is locked or not permitted to them, no topic is opened and the song still enters the library.',
	'MUSICSHARE_TOPIC_TITLE'		=> 'Title template',
	'MUSICSHARE_TOPIC_TITLE_EXPLAIN'	=> 'Placeholders: %1$s for the song title, %2$s for the artist. Maximum 120 characters, the rest is truncated. Example: <strong>%1$s - %2$s</strong> produces "Onde - Alex Baroni".',
	'MUSICSHARE_TOPIC_MESSAGE'		=> 'First post template',
	'MUSICSHARE_TOPIC_MESSAGE_EXPLAIN'	=> 'Placeholders: <strong>{BRANO}</strong> for the player, <strong>{TITOLO}</strong>, <strong>{ARTISTA}</strong> and <strong>{DESCRIZIONE}</strong>. BBCode is allowed. If you forget {BRANO} the player is added at the end anyway: a topic without the song would make no sense.',

	'MS_SEC_WEBPUSH'		=> '6. Browser push notifications',
	'MS_CHK_WP_INSTALLED'	=> 'phpBB Browser Push Notifications extension',
	'MS_CHK_WP_ENABLED'		=> 'Push notifications',
	'MS_CHK_WP_KEYS'		=> 'VAPID keys',
	'MS_CHK_WP_DEFAULT'		=> 'Push enabled by default',
	'MS_CHK_WP_SUBS'		=> 'Users with a registered device',
	'MS_CHK_WP_OPTOUT'		=> 'Users who turned push off for new songs',
	'MS_FIX_WP_INSTALLED'	=> 'Not required: without it, notices still arrive in the bell and by e-mail. If you install it, Music Share notifications go through push with no extra configuration, because phpBB applies notification methods to every registered type.',
	'MS_FIX_WP_ENABLED'		=> 'The extension is installed but push notifications are disabled: no push is sent at all, songs included. Enable them in the Browser Push Notifications settings.',
	'MS_FIX_WP_KEYS'		=> 'Without VAPID keys push cannot work. Generate them in the Browser Push Notifications settings.',
	'MS_FIX_WP_DEFAULT'		=> 'The push method is not enabled by default: each user has to turn it on manually in User Control Panel, Manage notifications. If you want it on for everyone, enable it in the Browser Push Notifications settings.',
	'MS_FIX_WP_SUBS'		=> 'No user has authorised their browser to receive notifications yet: until they do, no push can be sent. The permission is granted from their own User Control Panel.',
	'MS_FIX_WP_OPTOUT'		=> '%1$d users turned push off for new songs. That is their choice, no action needed.',

	'MS_CHK_TOPICS'			=> 'Songs with a discussion topic',
	'MS_FIX_TOPICS'			=> '%1$d songs have no topic, so the icon linking to the discussion does not appear for them. This is normal for songs uploaded before this feature was enabled: the topic is opened at upload time and cannot be created afterwards, because phpBB would attribute the post to whoever creates it now instead of to the song\'s author. For songs already in the library the only way is to open the topic by hand and paste the code found in "My songs".',

	'MS_ORPHANS'			=> 'Remove orphan files',
	'MS_ORPHAN_COUNT_LABEL'	=> 'Orphan files found',
	'MS_ORPHANS_EXPLAIN'	=> 'Deletes from disk the files that no song claims: leftovers from interrupted uploads or deleted songs. Songs in the library are not touched. Up to 500 files at a time.',
	'MS_ORPHANS_DONE'		=> 'Removed %1$d orphan files, %2$d could not be removed (check the folder permissions).',

	'MUSICSHARE_SHOW_LICENSE'		=> 'Ask for a usage licence',
	'MUSICSHARE_SHOW_LICENSE_EXPLAIN'	=> 'Adds a field where the author states what others may do with the song: free use, with credit, non-commercial only, all rights reserved. The licence is shown next to the song in the lists. On a board dedicated to loops and royalty-free music this is the most requested piece of information, and it puts the author\'s intentions in writing.',
	'MUSICSHARE_SHOW_BPM'			=> 'Ask for BPM and key',
	'MUSICSHARE_SHOW_BPM_EXPLAIN'	=> 'Adds two optional fields: beats per minute and key. They matter to anyone looking for a loop to fit into their own track.',
	'MUSICSHARE_FOLLOWS'			=> 'Allow users to follow each other',
	'MUSICSHARE_FOLLOWS_EXPLAIN'	=> 'Every user can follow whoever they want and be notified when that person publishes a song, even without the general notification permission. It is how to reopen notices without going back to one row per member: only those who asked for them receive them.',
	'MUSICSHARE_PLAYS_KEEP'			=> 'Keep detailed play records for',
	'MUSICSHARE_PLAYS_KEEP_EXPLAIN'	=> 'Days, from 0 to 3650. The dated detail feeds the period charts; beyond the longest window you show it is just weight. With 0 it is never removed. The overall play counter of each song is never touched.',

	'MUSICSHARE_PLAY_INTERVAL'		=> 'Minimum interval between counted plays',
	'MUSICSHARE_PLAY_INTERVAL_EXPLAIN'	=> 'Hours, from 0 to 168. Within this interval a second play of the same song by the same person is not counted. With 0 every playback counts. The recommended value is 12: replays on later days count, compulsive replays in the same evening do not. Regardless of this value, seeking within the progress bar is no longer counted as a new play, and guests are told apart by session rather than by user id, which is the same for all of them.',

	'MS_CHK_DL_LOG'			=> 'Download log',
	'MS_FIX_DL_LOG_MISSING'	=> 'The log table does not exist: the migration has not run. Disable and re-enable the extension from Manage extensions, then purge the cache.',
	'MS_FIX_DL_LOG_EMPTY'	=> 'No downloads recorded yet. A download is NOT counted in three cases: when the uploader downloads their own song, when the same person already downloaded that song within the minimum interval shown above, or when it is a parallel connection from a download manager. For a valid test: download a song uploaded by someone else, using a second account.',

	// ---- Tools tab ----
	'ACP_MUSICSHARE_TOOLS'	=> 'Tools',
	'MS_TOOLS_INTRO'		=> 'The numbers shown next to songs are convenient copies of data that lives elsewhere: likes in the votes table, downloads in their log. Such copies can drift from reality after a failed deletion or an interrupted migration. Here the totals are recomputed from the original tables.',
	'MS_TOOLS_COUNTERS'		=> 'Counters',
	'MS_TOOLS_REFERENCES'	=> 'Dangling references',
	'MS_TOOLS_RECALC'		=> 'Recalculate',
	'MS_TOOLS_FIX'			=> 'Fix',
	'MS_TOOLS_WRONG'		=> 'songs whose counter differs from the real data',
	'MS_TOOLS_STALE'		=> 'songs linked to a topic that no longer exists',
	'MS_TOOLS_ROWS'			=> 'rows referring to deleted songs',

	'MS_TOOLS_VOTES'		=> 'Likes and dislikes',
	'MS_TOOLS_VOTES_EXPLAIN'	=> 'Recomputes each song\'s vote counters from the votes table, which is the real data: one vote per user, revocable.',
	'MS_TOOLS_VOTES_DONE'	=> 'Vote counters recalculated: %d songs fixed.',

	'MS_TOOLS_DOWNLOADS'	=> 'Downloads',
	'MS_TOOLS_DOWNLOADS_EXPLAIN'	=> 'Recomputes download counters from the log. Note that the log is pruned according to the retention period you set: if more time than that has passed, recalculating will lower the numbers rather than correct them.',
	'MS_TOOLS_DOWNLOADS_DONE'	=> 'Download counters recalculated: %d songs fixed.',

	'MS_TOOLS_PLAYS'		=> 'Plays',
	'MS_TOOLS_PLAYS_EXPLAIN'	=> 'Not recalculable, and it is worth knowing why.',
	'MS_TOOLS_PLAYS_NOTE'	=> 'The play log is pruned periodically because it only feeds the period charts. Recomputing the total from it would not fix the numbers: it would zero everything older than the retained window. Better an imperfect counter than erased history.',

	'MS_TOOLS_TOPICS'		=> 'Discussion topics',
	'MS_TOOLS_TOPICS_EXPLAIN'	=> 'Unlinks songs from deleted or hidden topics. The link disappears from the lists and the author can open a new one. The extension already does this by itself when a topic is deleted: this button is for cases left over from before.',
	'MS_TOOLS_TOPICS_DONE'	=> 'Missing topics unlinked: %d songs fixed.',

	'MS_TOOLS_ORPHANS'		=> 'Rows referring to deleted songs',
	'MS_TOOLS_ORPHANS_EXPLAIN'	=> 'Removes votes, playlist entries, genre links, plays and downloads pointing to songs that no longer exist. They cause no errors, but take up space and skew the statistics.',
	'MS_TOOLS_ORPHANS_DONE'	=> 'Removed %d dangling rows.',

	'MS_TOOLS_OVERVIEW'		=> 'Overview',
	'MS_TOOLS_ZERO_NOTE'	=> 'In the boxes below, zero is good news: it counts how many things need fixing, not how many exist. The real totals are in the overview.',
	'MS_T_SONGS'			=> 'Songs in the library',
	'MS_T_APPROVED'			=> 'approved',
	'MS_T_PENDING'			=> 'pending',
	'MS_T_UPLOADERS'		=> 'Users who uploaded at least one song',
	'MS_T_SIZE'				=> 'Space used',
	'MS_T_PLAYS'			=> 'Total plays',
	'MS_T_DOWNLOADS'		=> 'Total downloads',
	'MS_T_VOTES'			=> 'Votes',
	'MS_T_LIKES'			=> 'likes',
	'MS_T_DISLIKES'			=> 'dislikes',
	'MS_T_ROWS'				=> 'rows in the votes table',
	'MS_T_IN_LOG'			=> 'in the dated log',
	'MS_T_TOPICS'			=> 'Songs with a discussion topic',
	'MS_T_PLAYLISTS'		=> 'Playlists created',
	'MS_T_GENRES'			=> 'Genres available',
	'MS_T_FOLLOWS'			=> 'Follow relationships, total',
	'MUSICSHARE_WALL_ENABLED'			=> 'Author walls',
	'MUSICSHARE_WALL_ENABLED_EXPLAIN'	=> 'Enables the comment box on every author page. Comments stay there, on the page: to discuss a song there is already its own board topic. Who can post and who can moderate is set through the Music Share permissions.',
	'MUSICSHARE_WALL_AUTHOR_MOD'		=> 'Authors moderate their own wall',
	'MUSICSHARE_WALL_AUTHOR_MOD_EXPLAIN'	=> 'When enabled, each author can edit and delete the comments received on their own page. Think it over: someone who deletes criticism leaves only what suits them on display, and nobody notices. Staff with the moderation permission can see and manage everything either way.',
	'MUSICSHARE_WALL_PREVIEW'			=> 'Comments shown on the page',
	'MUSICSHARE_WALL_PREVIEW_EXPLAIN'	=> 'How many comments to show per page on the wall. Replies to a comment are always shown in full underneath it. From 1 to 20.',
	'MUSICSHARE_WALL_FOLLOW_ONLY'		=> 'Only followers can comment',
	'MUSICSHARE_WALL_FOLLOW_ONLY_EXPLAIN'	=> 'When enabled, the writing box only appears to users already following the author; authors can always reply on their own page.',
	'MS_SET_STORAGE'		=> 'Storage and uploads',
	'MS_SET_LIBRARY'		=> 'Library and player',
	'MS_SET_USERS'			=> 'Users and plays',
	'MS_SET_TOPICS'			=> 'Song topics',
	'MS_SET_WALL'			=> 'Author walls',
	'MS_SET_IMPORT'			=> 'Import from posts',
	'MS_SET_TEXT'			=> 'Text and descriptions',
	'MS_SET_VOTES'			=> 'Votes and statistics',
	'MS_SET_INDEX'			=> 'Index block',
	'MS_SET_ALERTS'			=> 'Alerts and notifications',
	'MS_SET_MODERATION'		=> 'Moderation and cleanup',
	'MS_TOOLS_QUALITY'			=> 'Audio technical data',
	'MS_TOOLS_QUALITY_EXPLAIN'	=> 'Re-reads bitrate, VBR/CBR/ABR mode, sample rate and channels from the file. This covers songs uploaded before the extension read these values: the file is still there, it just needs analysing again. It runs in batches of 25 because every file has to be opened and read: press it repeatedly until the number reaches zero.',
	'MS_TOOLS_QUALITY_MISSING'	=> 'songs without technical data',
	'MS_TOOLS_QUALITY_RUN'		=> 'Re-read 25 songs',
	'MS_TOOLS_QUALITY_DONE'		=> '%1$d songs updated, %2$d skipped, %3$d still to read. Skipped ones have no file, or a file with no readable bitrate: they get marked and will not come back in later batches.',
]);
