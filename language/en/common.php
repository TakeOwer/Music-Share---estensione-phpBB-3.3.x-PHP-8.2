...
$lang = array_merge($lang, [
	...
	'MUSICSHARE_NOTIFICATION_WALL'			=> 'Someone posts on my wall',
	'MUSICSHARE_NOTIFICATION_WALL_TITLE'	=> '<strong>%1$s</strong> posted on your wall.',
	'MUSICSHARE_NOTIFICATION_WALL_REPLY'	=> 'Someone replies to my wall comment',
	'MUSICSHARE_NOTIFICATION_WALL_REPLY_TITLE'	=> '<strong>%1$s</strong> replied to your comment.',
	...
	// Importing an audio attachment into the library
	'MUSICSHARE_ATTACH_IMPORT'		=> 'Add to library',
	'MUSICSHARE_IMPORT_FILE'		=> 'File to import',
	'MUSICSHARE_IMPORT_FILE_EXPLAIN'	=> 'The attachment stays in the post: a copy is saved in the library, so the song keeps working even if the post is later edited or removed.',
	'MUSICSHARE_IMPORT_SUBMIT'		=> 'Add to library',
	'MUSICSHARE_IMPORT_DONE'		=> 'Song added to the library.',
	'MUSICSHARE_IMPORT_ALREADY'		=> 'This file is already in your library: it was not added a second time.',
	'MUSICSHARE_MY_SONGS'			=> 'My songs',
	'MUSICSHARE_ATTACH_NOT_FOUND'	=> 'Attachment not found.',
	'MUSICSHARE_ATTACH_NOT_AUDIO'	=> 'This attachment is not in one of the accepted audio formats.',
	'MUSICSHARE_ATTACH_FILE_MISSING'	=> 'The attachment file is no longer on the server.',
	'MUSICSHARE_ATTACH_IMPORT_OFF'	=> 'Importing attachments into the library is disabled.',
	'MUSICSHARE_TITLE_REQUIRED'		=> 'Please enter a title for the song.',

	'MUSICSHARE_DISCUSS'			=> 'Discuss this song',

	'MUSICSHARE_CREATE_TOPIC'		=> 'Board discussion',
	'MUSICSHARE_CREATE_TOPIC_YES'	=> 'Open a topic for this song',
	'MUSICSHARE_CREATE_TOPIC_EXPLAIN'	=> 'A topic is opened in your name with the player already embedded, where others can comment. If you do not want it now, you can open it later from the button next to the song.',
	'MUSICSHARE_PUBLISH_TOPIC'		=> 'Open the discussion for this song',
	'MUSICSHARE_TOPIC_OFF'			=> 'Automatic topic creation is disabled.',
	'MUSICSHARE_TOPIC_NOT_YOURS'	=> 'You can only open the discussion for songs you uploaded: the topic would be posted in your name.',
	'MUSICSHARE_TOPIC_PENDING'		=> 'The song is still awaiting approval: the discussion can be opened once it is visible to everyone.',
	'MUSICSHARE_TOPIC_FAILED'		=> 'The topic could not be opened. Check that you are allowed to post in the section chosen by the administrator.',

	'MUSICSHARE_LIKED'			=> 'Songs I like',
	'MUSICSHARE_LIKED_EMPTY'	=> 'You have not liked any song yet. The thumbs up next to each song adds it here.',
	'MUSICSHARE_LIKED_LOGIN'	=> 'You need to be logged in to see your liked songs.',

	'MCP_MUSICSHARE_BULK'			=> 'Action on selected songs',
	'MCP_MUSICSHARE_BULK_CHOOSE'	=> 'Choose an action...',
	'MCP_MUSICSHARE_BULK_EXPLAIN'	=> 'Up to 100 songs at a time. Songs already in the requested state are skipped and their uploaders are not sent a second notice.',
	'MCP_MUSICSHARE_BULK_DONE'		=> 'Done: %1$d songs changed, %2$d skipped.',
	'MCP_MUSICSHARE_NONE_SELECTED'	=> 'You have not selected any song.',

	'MUSICSHARE_TOP_PERIOD_7'		=> 'Last 7 days',
	'MUSICSHARE_TOP_PERIOD_30'		=> 'Last month',
	'MUSICSHARE_TOP_PERIOD_ALL'		=> 'All time',

	'MUSICSHARE_FOLLOW'			=> 'Follow this user',
	'MUSICSHARE_UNFOLLOW'		=> 'Unfollow',
	'MUSICSHARE_FOLLOWERS'		=> 'Followed by',
	'MUSICSHARE_FOLLOW_EXPLAIN'	=> 'You will be notified when they publish a new song, even if general notifications are not enabled for you.',
	'MUSICSHARE_FOLLOW_LOGIN'	=> 'You need to be logged in to follow a user.',
	'MUSICSHARE_FOLLOW_OFF'		=> 'The follow feature is disabled on this board.',
	'MUSICSHARE_FOLLOW_SELF'	=> 'You cannot follow yourself.',

	// Details for people who want to use the song, not just listen to it
	'MUSICSHARE_LICENSE'		=> 'Usage licence',
	'MUSICSHARE_LICENSE_EXPLAIN'	=> 'State what you allow others to do with your song. It is not a contract and does not replace a written agreement, but it puts your intentions in writing and avoids misunderstandings.',
	'MUSICSHARE_LIC_NONE'		=> 'Not stated',
	'MUSICSHARE_LIC_CC0'		=> 'CC0 - Free use, no conditions',
	'MUSICSHARE_LIC_CCBY'		=> 'CC BY - Free, with credit',
	'MUSICSHARE_LIC_CCBYSA'		=> 'CC BY-SA - Free, with credit and the same licence',
	'MUSICSHARE_LIC_CCBYNC'		=> 'CC BY-NC - Free for non-commercial use, with credit',
	'MUSICSHARE_LIC_FREE'		=> 'Free use, commercial included',
	'MUSICSHARE_LIC_ASK'		=> 'Contact me before using it',
	'MUSICSHARE_LIC_ALLRIGHTS'	=> 'All rights reserved - listening only',
	'MUSICSHARE_BPM'			=> 'Beats per minute (BPM)',
	'MUSICSHARE_BPM_EXPLAIN'	=> 'Optional. Useful to anyone looking for a loop to use in their own track. Leave 0 if you do not know it.',
	'MUSICSHARE_KEY'			=> 'Key',
	'MUSICSHARE_KEY_EXPLAIN'	=> 'Optional. The key is the note a track settles on: it helps anyone who wants to mix it or play along. Click the field to pick from the list, or type it yourself: both English notation (Am, F#m, C) and Italian notation (la minore, do maggiore) are accepted. Leave it empty if you do not know it, it is not required.',
	'MUSICSHARE_KEY_NOTES'		=> 'C,C#,D,Eb,E,F,F#,G,Ab,A,Bb,B',
	'MUSICSHARE_KEY_MAJOR'		=> 'major',
	'MUSICSHARE_KEY_MINOR'		=> 'minor',
	'MUSICSHARE_KBITS'			=> 'kbit/s',
	'MUSICSHARE_KHZ'			=> 'kHz',
	'MUSICSHARE_DECIMAL'		=> '.',
	'MUSICSHARE_MONO'			=> 'Mono',
	'MUSICSHARE_STEREO'			=> 'Stereo',
	'MUSICSHARE_CHANNELS_N'		=> '%d channels',
	'MUSICSHARE_REPLACE_FILE'	=> 'Replace the audio file',
	'MUSICSHARE_REPLACE_FILE_EXPLAIN'	=> 'Upload a new version of the song. Plays, votes, genres and discussion stay as they were: only the content changes. Leave empty to keep the current file.',

	'MUSICSHARE_DOWNLOADS'		=> 'Total downloads',
	'MUSICSHARE_STATS'			=> 'Plays / Downloads',

	'MUSICSHARE_PLAYLIST_SONGS'		=> 'Songs',

	'MUSICSHARE_FOLLOWING_NEWS'		=> 'News from people you follow',
	'MUSICSHARE_FOLLOWS_LIST'		=> 'People you follow',
	'MUSICSHARE_FOLLOW_SINCE'		=> 'Following since',
	'MUSICSHARE_FOLLOWING_EMPTY'	=> 'The people you follow have not published any songs yet.',
	'MUSICSHARE_FOLLOWING_NOBODY'	=> 'You are not following anyone yet. The "Follow this user" button is on every author\'s page: from then on you will be notified when they publish, and their songs will appear here.',

	'MUSICSHARE_BACK_LIBRARY'		=> 'Back to the library',
	'MUSICSHARE_FOLLOWING_COUNT'	=> 'People followed',

	'MUSICSHARE_CONTACT'			=> 'Contact the author',
	'MUSICSHARE_CONTACT_EXPLAIN'	=> 'Opens a board private message. Useful to ask permission to use a song or to propose a collaboration.',

	'MUSICSHARE_PM_SUBJECT'			=> 'About: %s',

	// public author page
	'MUSICSHARE_AUTHOR'				=> 'Author',
	'MUSICSHARE_AUTHOR_SINCE'		=> 'member since',
	'MUSICSHARE_AUTHOR_PROFILE'		=> 'Board profile',
	'MUSICSHARE_AUTHOR_ALL_SONGS'	=> 'Full catalogue',
	'MUSICSHARE_AUTHOR_EMPTY'		=> 'This user has not published any songs yet. You can follow them from here: you will be notified as soon as they upload one.',
	'MUSICSHARE_USER_NOT_FOUND'		=> 'This user does not exist.',
	'MUSICSHARE_STAT_SONGS'			=> 'Songs',
	'MUSICSHARE_STAT_PLAYS'			=> 'Plays',
	'MUSICSHARE_STAT_DOWNLOADS'		=> 'Downloads',
	'MUSICSHARE_STAT_LIKES'			=> 'Likes',
	'MUSICSHARE_STAT_DISLIKES'		=> 'Dislikes',

	// author wall
	'MUSICSHARE_WALL'				=> 'Wall',
	'MUSICSHARE_WALL_EMPTY'			=> 'No comments yet.',
	'MUSICSHARE_WALL_SEND'			=> 'Post on the wall',
	'MUSICSHARE_WALL_PLACEHOLDER'	=> 'Write a comment...',
	'MUSICSHARE_WALL_REPLY'			=> 'Reply',
	'MUSICSHARE_WALL_REPLY_PLACEHOLDER'	=> 'Write a reply...',
	'MUSICSHARE_WALL_EDITED'		=> 'edited on',
	'MUSICSHARE_WALL_EDITED_MOD'	=> 'edited by a moderator on',
	'MUSICSHARE_WALL_HEART'			=> 'This one touches me',
	'MUSICSHARE_WALL_REACT_OWN'		=> 'You cannot react to your own comment.',
	'MUSICSHARE_WALL_DELETE_CONFIRM'	=> 'Delete this comment? Any replies to it will be removed as well.',
	'MUSICSHARE_WALL_EXPLAIN'		=> 'Your comment stays on this page. BBCode and smilies are allowed.',
	'MUSICSHARE_WALL_EMPTY_TEXT'	=> 'The comment is empty.',
	'MUSICSHARE_WALL_NOT_FOUND'		=> 'This comment does not exist.',
	'MUSICSHARE_WALL_LOGIN'			=> 'You must be logged in to comment.',
	'MUSICSHARE_WALL_NO_PERMISSION'	=> 'You are not allowed to post on walls.',
	'MUSICSHARE_WALL_FOLLOW_FIRST'	=> 'Only users following this author can post on their wall.',
	'MUSICSHARE_WALL_OFF'			=> 'Walls are not enabled.',
]);
