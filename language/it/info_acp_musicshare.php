...
$lang = array_merge($lang, [
	...
	'MS_SEC_FEATURES'		=> '7. Funzioni facoltative',
	...
	'MUSICSHARE_ATTACH_IMPORT_OPT'		=> 'Importazione degli allegati audio in libreria',
	'MUSICSHARE_ATTACH_IMPORT_OPT_EXPLAIN'	=> 'Mostra sotto ogni allegato audio di un messaggio il collegamento "Aggiungi alla libreria", visibile solo a chi ha scritto il messaggio e a chi modera i brani. L\'importazione non e\' mai automatica: l\'autore sceglie titolo, artista e generi, e solo allora il brano entra in libreria. Dell\'allegato viene salvata una copia, cosi\' il brano continua a funzionare anche se il messaggio viene poi modificato o rimosso.',

	'MUSICSHARE_AUTO_IMPORT'		=> 'Importazione automatica dai forum',
	'MUSICSHARE_AUTO_IMPORT_EXPLAIN'	=> 'Quando un utente allega un file audio a un messaggio scritto in uno dei forum selezionati qui sotto, il brano entra da solo in libreria, con titolo e artista letti dai tag del file. Non serve alcun intervento dell\'autore. Se l\'importazione fallisce, il messaggio viene pubblicato ugualmente e l\'allegato resta scaricabile come sempre.',
	'MUSICSHARE_AUTO_FORUMS'		=> 'Forum da cui importare',
	'MUSICSHARE_AUTO_FORUMS_EXPLAIN'	=> 'Seleziona solo le sezioni dedicate alla musica. Attenzione: la libreria e\' unica e visibile a chiunque abbia accesso alla sezione Musica, mentre i forum hanno permessi di lettura propri. Importando da una sezione riservata, quei brani diventerebbero ascoltabili anche da chi non puo\' leggere quel forum. Le sezioni non leggibili dagli ospiti sono contrassegnate.',
	'MUSICSHARE_FORUM_PRIVATE'		=> 'non pubblico',
	'MUSICSHARE_AUTO_PENDING'		=> 'Metti in approvazione i brani importati',
	'MUSICSHARE_AUTO_PENDING_EXPLAIN'	=> 'Consigliato. I brani importati automaticamente non sono stati scelti uno per uno da nessuno: restano in attesa finche\' un moderatore non li esamina, anche se l\'approvazione generale dei caricamenti e\' disattivata. Li trovi nel Pannello di Controllo Moderatore.',

	'MUSICSHARE_TOPIC_ENABLED'		=> 'Apri un argomento per ogni brano caricato',
	'MUSICSHARE_TOPIC_ENABLED_EXPLAIN'	=> 'Quando un utente carica un brano, viene aperto nel forum scelto qui sotto un argomento a suo nome, con il lettore gia\' incorporato. La discussione nasce cosi\' dove si discute di tutto il resto, e i commenti sono messaggi veri del forum. L\'argomento viene aperto solo per i brani immediatamente visibili: se il brano resta in attesa di approvazione, nessun argomento viene creato.',
	'MUSICSHARE_TOPIC_FORUM'		=> 'Forum in cui aprire gli argomenti',
	'MUSICSHARE_TOPIC_FORUM_NONE'	=> '(nessuno: funzione inattiva)',
	'MUSICSHARE_TOPIC_FORUM_EXPLAIN'	=> 'Scegli una sezione dedicata. Gli utenti devono potervi scrivere: se il forum e\' chiuso o vietato loro, l\'argomento non viene aperto e il brano entra comunque in libreria.',
	'MUSICSHARE_TOPIC_TITLE'		=> 'Modello del titolo',
	'MUSICSHARE_TOPIC_TITLE_EXPLAIN'	=> 'Segnaposti: %1$s per il titolo del brano, %2$s per l\'artista. Massimo 120 caratteri, il resto viene troncato. Esempio: <strong>%1$s - %2$s</strong> produce "Onde - Alex Baroni".',
	'MUSICSHARE_TOPIC_MESSAGE'		=> 'Modello del primo messaggio',
	'MUSICSHARE_TOPIC_MESSAGE_EXPLAIN'	=> 'Segnaposti: <strong>{BRANO}</strong> per il lettore, <strong>{TITOLO}</strong>, <strong>{ARTISTA}</strong> e <strong>{DESCRIZIONE}</strong>. Il BBCode e\' consentito. Se dimentichi {BRANO} il lettore viene aggiunto in fondo lo stesso: un argomento senza brano non avrebbe senso.',

	'MS_SEC_WEBPUSH'		=> '6. Notifiche push del browser',
	'MS_CHK_WP_INSTALLED'	=> 'Estensione phpBB Browser Push Notifications',
	'MS_CHK_WP_ENABLED'		=> 'Notifiche push',
	'MS_CHK_WP_KEYS'		=> 'Chiavi VAPID',
	'MS_CHK_WP_DEFAULT'		=> 'Push attivo per impostazione predefinita',
	'MS_CHK_WP_SUBS'		=> 'Utenti con un dispositivo registrato',
	'MS_CHK_WP_OPTOUT'		=> 'Utenti che hanno spento il push per i nuovi brani',
	'MS_FIX_WP_INSTALLED'	=> 'Non e\' necessaria: senza di essa gli avvisi arrivano comunque nella campanella e per email. Se la installi, le notifiche di Music Share passano dal push senza alcuna configurazione aggiuntiva, perche\' phpBB applica i metodi di notifica a tutti i tipi registrati.',
	'MS_FIX_WP_ENABLED'		=> 'L\'estensione e\' installata ma le notifiche push sono disattivate: nessuna push viene inviata, nemmeno per i brani. Attivale nelle impostazioni dell\'estensione Browser Push Notifications.',
	'MS_FIX_WP_KEYS'		=> 'Senza le chiavi VAPID il push non puo\' funzionare. Generale nelle impostazioni dell\'estensione Browser Push Notifications.',
	'MS_FIX_WP_DEFAULT'		=> 'Il metodo push non e\' attivo per impostazione predefinita: ogni utente deve accenderlo a mano in Pannello utente, Gestisci notifiche. Se vuoi che valga per tutti, attivalo nelle impostazioni dell\'estensione Browser Push Notifications.',
	'MS_FIX_WP_SUBS'		=> 'Nessun utente ha ancora autorizzato il browser a ricevere le notifiche: finche\' non lo fanno, nessuna push puo\' partire. L\'autorizzazione si concede dal proprio Pannello utente.',
	'MS_FIX_WP_OPTOUT'		=> '%1$d utenti hanno disattivato il push per i nuovi brani. E\' una loro scelta, nessun intervento necessario.',

	'MS_CHK_TOPICS'			=> 'Brani con un argomento di discussione',
	'MS_FIX_TOPICS'			=> '%1$d brani non hanno un argomento, e l\'icona che porta alla discussione non compare per loro. E\' normale per i brani caricati prima di attivare questa funzione: l\'argomento viene aperto al momento del caricamento e non puo\' essere creato a posteriori, perche\' phpBB attribuirebbe il messaggio a chi lo crea adesso invece che all\'autore del brano. Per i brani gia\' in libreria l\'unica strada e\' aprire l\'argomento a mano e incollarvi il codice che trovi in "I miei brani".',

	'MS_ORPHANS'			=> 'Rimuovi i file orfani',
	'MS_ORPHAN_COUNT_LABEL'	=> 'File orfani trovati',
	'MS_ORPHANS_EXPLAIN'	=> 'Cancella dal disco i file che nessun brano rivendica: residui di caricamenti interrotti o di brani eliminati. I brani in libreria non vengono toccati. Massimo 500 file per volta.',
	'MS_ORPHANS_DONE'		=> 'Rimossi %1$d file orfani, %2$d non rimovibili (controlla i permessi della cartella).',

	'MUSICSHARE_SHOW_LICENSE'		=> 'Chiedi la licenza d\'uso dei brani',
	'MUSICSHARE_SHOW_LICENSE_EXPLAIN'	=> 'Aggiunge ai moduli un campo in cui l\'autore dichiara cosa consente a chi vuole usare il suo brano: uso libero, con citazione, solo non commerciale, tutti i diritti riservati. La licenza compare accanto al brano negli elenchi. Per un forum dedicato a loop e musica royalty free e\' l\'informazione piu\' richiesta, e mette per iscritto le intenzioni dell\'autore.',
	'MUSICSHARE_SHOW_BPM'			=> 'Chiedi BPM e tonalita\' dei brani',
	'MUSICSHARE_SHOW_BPM_EXPLAIN'	=> 'Aggiunge due campi facoltativi: battiti al minuto e tonalita\'. Servono a chi cerca un loop da inserire in un proprio pezzo e vuole sapere se si accorda con quello che sta facendo.',
	'MUSICSHARE_FOLLOWS'			=> 'Consenti di seguire gli altri utenti',
	'MUSICSHARE_FOLLOWS_EXPLAIN'	=> 'Ogni utente puo\' seguire chi vuole e ricevere una notifica quando quella persona pubblica un brano, anche senza il permesso generale sulle notifiche. E\' il modo di riaprire gli avvisi senza tornare a una riga per ogni iscritto: ne riceve solo chi lo ha chiesto.',
	'MUSICSHARE_PLAYS_KEEP'			=> 'Conserva il dettaglio degli ascolti per',
	'MUSICSHARE_PLAYS_KEEP_EXPLAIN'	=> 'Giorni, da 0 a 3650. Il dettaglio datato serve alle classifiche per periodo; oltre la finestra piu\' lunga che mostri diventa solo peso. Con 0 non viene mai rimosso. Il conteggio complessivo degli ascolti di ogni brano non viene comunque toccato.',

	'MUSICSHARE_PLAY_INTERVAL'		=> 'Intervallo minimo fra due ascolti conteggiati',
	'MUSICSHARE_PLAY_INTERVAL_EXPLAIN'	=> 'Ore, da 0 a 168. Entro questo intervallo un secondo ascolto della stessa persona sullo stesso brano non viene conteggiato. Con 0 conta ogni riproduzione. Il valore consigliato e\' 12: i riascolti nei giorni successivi contano, quelli compulsivi nella stessa serata no. Indipendentemente da questo valore, gli spostamenti nella barra di avanzamento non vengono piu\' contati come ascolti nuovi, e gli ospiti sono distinti per sessione invece che per identificativo utente, che per loro e\' uguale per tutti.',

	'MS_CHK_DL_LOG'			=> 'Registro dei download',
	'MS_FIX_DL_LOG_MISSING'	=> 'La tabella del registro non esiste: la migrazione non e\' stata eseguita. Disabilita e riabilita l\'estensione da Gestione estensioni, poi svuota la cache.',
	'MS_FIX_DL_LOG_EMPTY'	=> 'Nessun download registrato finora. Un download NON viene conteggiato in tre casi: se lo fa l\'autore sul proprio brano, se la stessa persona ha gia\' scaricato quel brano entro l\'intervallo minimo indicato qui sopra, oppure se si tratta di una connessione parallela di un gestore di download. Per una prova valida: scarica con un secondo account un brano caricato da qualcun altro.',

	// ---- Scheda Strumenti ----
	'ACP_MUSICSHARE_TOOLS'	=> 'Strumenti',
	'MS_TOOLS_INTRO'		=> 'I numeri mostrati accanto ai brani sono copie comode di dati che vivono altrove: i mi piace nella tabella dei voti, i download nel loro registro. Copie del genere possono scollarsi dalla realta\' dopo una cancellazione andata storta o una migrazione interrotta. Qui si rifanno i conti dalle tabelle originali.',
	'MS_TOOLS_COUNTERS'		=> 'Contatori',
	'MS_TOOLS_REFERENCES'	=> 'Riferimenti rimasti appesi',
	'MS_TOOLS_RECALC'		=> 'Ricalcola',
	'MS_TOOLS_FIX'			=> 'Correggi',
	'MS_TOOLS_WRONG'		=> 'brani con un contatore diverso dal dato reale',
	'MS_TOOLS_STALE'		=> 'brani collegati a un argomento che non esiste piu\'',
	'MS_TOOLS_ROWS'			=> 'righe riferite a brani eliminati',

	'MS_TOOLS_VOTES'		=> 'Mi piace e non mi piace',
	'MS_TOOLS_VOTES_EXPLAIN'	=> 'Rifa\' il conto dei voti di ogni brano leggendo la tabella dei voti, che e\' il dato vero: un voto per utente, revocabile.',
	'MS_TOOLS_VOTES_DONE'	=> 'Contatori dei voti ricalcolati: %d brani corretti.',

	'MS_TOOLS_DOWNLOADS'	=> 'Download',
	'MS_TOOLS_DOWNLOADS_EXPLAIN'	=> 'Rifa\' il conto dei download leggendo il registro. Tieni presente che il registro viene sfoltito secondo il periodo di conservazione impostato: se e\' passato piu\' tempo di quel periodo, il ricalcolo abbassera\' i numeri invece di correggerli.',
	'MS_TOOLS_DOWNLOADS_DONE'	=> 'Contatori dei download ricalcolati: %d brani corretti.',

	'MS_TOOLS_PLAYS'		=> 'Ascolti',
	'MS_TOOLS_PLAYS_EXPLAIN'	=> 'Non ricalcolabili, ed e\' bene sapere perche\'.',
	'MS_TOOLS_PLAYS_NOTE'	=> 'Il registro degli ascolti viene sfoltito periodicamente perche\' serve solo alle classifiche per periodo. Ricalcolare il totale da li\' non correggerebbe i numeri: li azzererebbe per tutto cio\' che e\' piu\' vecchio della finestra conservata. Meglio un contatore imperfetto che una cancellazione della storia.',

	'MS_TOOLS_TOPICS'		=> 'Argomenti di discussione',
	'MS_TOOLS_TOPICS_EXPLAIN'	=> 'Slega i brani dagli argomenti cancellati o nascosti. Il collegamento sparisce dagli elenchi e l\'autore puo\' aprirne uno nuovo. L\'estensione lo fa gia\' da sola quando un argomento viene cancellato: questo pulsante serve per i casi rimasti indietro.',
	'MS_TOOLS_TOPICS_DONE'	=> 'Argomenti inesistenti slegati: %d brani corretti.',

	'MS_TOOLS_ORPHANS'		=> 'Righe riferite a brani eliminati',
	'MS_TOOLS_ORPHANS_EXPLAIN'	=> 'Rimuove voti, voci di playlist, associazioni di genere, ascolti e download che puntano a brani non piu\' esistenti. Non causano errori, ma occupano spazio e falsano le statistiche.',
	'MS_TOOLS_ORPHANS_DONE'	=> 'Rimosse %d righe rimaste appese.',

	'MS_TOOLS_OVERVIEW'		=> 'Quadro d\'insieme',
	'MS_TOOLS_ZERO_NOTE'	=> 'Nei riquadri qui sotto lo zero e\' una buona notizia: indica quante cose ci sono da correggere, non quante ce ne sono in tutto. I totali reali sono nel quadro d\'insieme.',
	'MS_T_SONGS'			=> 'Brani in libreria',
	'MS_T_APPROVED'			=> 'approvati',
	'MS_T_PENDING'			=> 'in attesa',
	'MS_T_UPLOADERS'		=> 'Utenti che hanno caricato almeno un brano',
	'MS_T_SIZE'				=> 'Spazio occupato',
	'MS_T_PLAYS'			=> 'Ascolti totali',
	'MS_T_DOWNLOADS'		=> 'Download totali',
	'MS_T_VOTES'			=> 'Voti',
	'MS_T_LIKES'			=> 'mi piace',
	'MS_T_DISLIKES'			=> 'non mi piace',
	'MS_T_ROWS'				=> 'righe nella tabella dei voti',
	'MS_T_IN_LOG'			=> 'nel registro datato',
	'MS_T_TOPICS'			=> 'Brani con un argomento di discussione',
	'MS_T_PLAYLISTS'		=> 'Playlist create',
	'MS_T_GENRES'			=> 'Generi disponibili',
	'MS_T_FOLLOWS'			=> 'Utenti seguiti, in totale',
	'MUSICSHARE_WALL_ENABLED'			=> 'Bacheca degli autori',
	'MUSICSHARE_WALL_ENABLED_EXPLAIN'	=> 'Attiva il riquadro dei commenti sulla pagina di ogni autore. I commenti restano li\', sulla pagina: per discutere di un brano c\'e\' gia\' il suo argomento sul forum. Chi puo\' scrivere e chi puo\' moderare si decide con i permessi del gruppo Music Share.',
	'MUSICSHARE_WALL_AUTHOR_MOD'		=> 'L\'autore modera la propria bacheca',
	'MUSICSHARE_WALL_AUTHOR_MOD_EXPLAIN'	=> 'Se attivo, ogni autore puo\' modificare ed eliminare i commenti ricevuti sulla propria pagina. Pensaci: chi cancella le critiche lascia in vista solo cio\' che gli fa comodo, e nessuno se ne accorge. Lo staff con il permesso di moderazione vede e gestisce tutto in ogni caso.',
	'MUSICSHARE_WALL_PREVIEW'			=> 'Commenti mostrati nella pagina',
	'MUSICSHARE_WALL_PREVIEW_EXPLAIN'	=> 'Quanti commenti mostrare per pagina sulla bacheca. Le risposte a un commento si vedono sempre tutte sotto di esso. Da 1 a 20.',
	'MUSICSHARE_WALL_FOLLOW_ONLY'		=> 'Solo chi segue puo\' commentare',
	'MUSICSHARE_WALL_FOLLOW_ONLY_EXPLAIN'	=> 'Se attivo, il modulo per scrivere compare solo a chi gia\' segue l\'autore; l\'autore stesso puo\' sempre rispondere a casa propria.',
	'MS_SET_STORAGE'		=> 'Archiviazione e caricamento',
	'MS_SET_LIBRARY'		=> 'Libreria e lettore',
	'MS_SET_USERS'			=> 'Utenti e ascolti',
	'MS_SET_TOPICS'			=> 'Argomenti dei brani',
	'MS_SET_WALL'			=> 'Bacheca degli autori',
	'MS_SET_IMPORT'			=> 'Importazione dai messaggi',
	'MS_SET_TEXT'			=> 'Testi e descrizioni',
	'MS_SET_VOTES'			=> 'Voti e statistiche',
	'MS_SET_INDEX'			=> 'Riquadro nell\'indice',
	'MS_SET_ALERTS'			=> 'Avvisi e notifiche',
	'MS_SET_MODERATION'		=> 'Moderazione e pulizia',
	'MS_TOOLS_QUALITY'			=> 'Dati tecnici dell\'audio',
	'MS_TOOLS_QUALITY_EXPLAIN'	=> 'Rilegge dal file bitrate, modalita\' VBR/CBR/ABR, frequenza e canali. Riguarda i brani caricati prima che l\'estensione leggesse questi dati: il file c\'e\' ancora, basta rianalizzarlo. Si procede a blocchi di 25 perche\' ogni file va aperto e letto: premi piu\' volte finche\' il numero non arriva a zero.',
	'MS_TOOLS_QUALITY_MISSING'	=> 'brani senza i dati tecnici',
	'MS_TOOLS_QUALITY_RUN'		=> 'Rileggi 25 brani',
	'MS_TOOLS_QUALITY_DONE'		=> '%1$d brani aggiornati, %2$d saltati, %3$d ancora da rileggere. I saltati sono quelli senza file o con un file da cui non si ricava il bitrate: vengono marcati e non tornano nei blocchi successivi.',
]);
